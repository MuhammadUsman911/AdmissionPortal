...
// @description fetch current applicant imformation
// @access  private
...
// @router  PUT /api/applicant/personalDetails
...
router.put(
  ...
  [
    ...
    check('fatherName', 'Please enter father name').not().isEmpty(),
    check('cnic', 'Enter CNIC number').not().isEmpty(),
    check('frontPic', 'Add front side picture of CNIC')
      .not()
      .isEmpty()
      .not()
      .isEmpty(),
    check('backPic', 'Add back side picture of CNIC')
      .not()
      .isEmpty()
      .not()
      .isEmpty(),
    check('address', 'Please enter address').not().isEmpty().not().isEmpty(),
    check('domicile', 'Please enter domicile').not().isEmpty().not().isEmpty(),
    check('dateOfBirth', 'Please enter birth date')
      .not()
      .isEmpty()
      .not()
      .isEmpty(),
    check('phoneNumber', 'Please enter phone number')
      .not()
      .isEmpty()
      .not()
      .isEmpty(),
    check('birthPlace', 'Please enter birth Place ')
      .not()
      .isEmpty()
      .not()
      .isEmpty(),
